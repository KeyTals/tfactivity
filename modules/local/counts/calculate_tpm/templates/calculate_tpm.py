...
# Keep only the genes present in both df_counts and df_lengths
common_genes = df_counts.index.intersection(df_lengths.index)
df_counts = df_counts.loc[common_genes]
df_lengths = df_lengths.loc[common_genes]
